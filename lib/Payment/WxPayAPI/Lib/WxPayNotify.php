...
use Lib\Payment\WxPayAPI\Lib\WxPayData\WxPayNotifyReply;
...
class WxPayNotify extends WxPayNotifyReply
{
	 ...
	 */
	final public function Handle($appid, $store_id, $needSign = true, $xml)
	{
		...
		$result = WxPayApi::notify(array($this, 'NotifyCallBack'), $appid, $store_id,
            $xml, $storeInfoConfig['wechat']['wechat_key'], $msg);
		if($result == false) {
